    ...
    <!-- <input id = "gugunInput" type="hidden" value="" name="gugunCd"/> -->
        <fieldset>
            ...
            <div class="row full">
                ...
                <input name="pwd" type="password" id="password" placeholder="비밀번호 설정하기 (8~12자까지 입력해주세요.)"
...
<!-- 200810 조현득 -->
                <input type="hidden" name="birth" value="birthDate" id="birthDate"/>
            ...
            <div class="row box_verify">
                ...
                <input name="phoneNum" autocomplete="off" id="phoneNumber" type="text" placeholder="전화번호 입력"/>
